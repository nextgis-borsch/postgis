...
{
  static VectorTile__Tile__Value init_value = VECTOR_TILE__TILE__VALUE__INIT;
  *message = init_value;
}
void   vector_tile__tile__feature__init
                     (VectorTile__Tile__Feature         *message)
{
  static VectorTile__Tile__Feature init_value = VECTOR_TILE__TILE__FEATURE__INIT;
  *message = init_value;
}
void   vector_tile__tile__layer__init
                     (VectorTile__Tile__Layer         *message)
{
  static VectorTile__Tile__Layer init_value = VECTOR_TILE__TILE__LAYER__INIT;
  *message = init_value;
}
void   vector_tile__tile__init
                     (VectorTile__Tile         *message)
{
  static VectorTile__Tile init_value = VECTOR_TILE__TILE__INIT;
  *message = init_value;
}
